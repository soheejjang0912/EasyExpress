                       ...
                       <body>
						  ...
						  %>
	                       <table border="1" bordercolor="black" width="900" height="50">
							...
							<li><a href="expressExpClearRegister.jsp?resID=<%= express.getResID() %>">수출통관상태 변경</a></li>
							<table border="0" width="100%" border="0" cellspacing="0" cellpadding="0" >
								<tr>
									<td style="padding-top: 10; padding-right: 0; padding-bottom: 30; padding-left: 0;">&nbsp</td> 
								</tr>
							...
							<li><a href="expressTransRegister.jsp?resID=<%= express.getResID() %>">운송상태 변경</a></li>
							<table border="0" width="100%" border="0" cellspacing="0" cellpadding="0" >
								<tr>
									<td style="padding-top: 10; padding-right: 0; padding-bottom: 30; padding-left: 0;">&nbsp</td> 
								</tr>
							...
							<li><a href="expressImpRegister.jsp?resID=<%= express.getResID() %>">수입 통관상태 변경</a></li>
							<table border="0" width="100%" border="0" cellspacing="0" cellpadding="0" >
								<tr>
									<td style="padding-top: 10; padding-right: 0; padding-bottom: 30; padding-left: 0;">&nbsp</td> 
								</tr>
							...
							<li><a href="expressDeliRegister.jsp?resID=<%= express.getResID() %>">육상운송상태 변경</a></li>
							<table border="0" width="100%" border="0" cellspacing="0" cellpadding="0" >
								<tr>
									<td style="padding-top: 10; padding-right: 0; padding-bottom: 30; padding-left: 0;">&nbsp</td> 
								</tr>
