                    ...
                    <div class="col-md-6 col-xs-6 col-md-offset-1 col-sm-7 col-lg-offset-1 col-lg-6 mobMenuCol">
                        <nav class="navbar">
                                ...
                                <ul class="nav navbar-nav navbar-right menu">
                                    <li><a href="index.jsp">home<span class="caret"></span></a>
                                        <ul class="dropdownMenu">
                                            <li><a href="index-2.jsp">Home 2</a></li>
                                            <li><a href="index-3.jsp">Home 3</a></li>
                                            <li><a href="index-4.jsp">Home 4</a></li>
                                            <li><a href="index-5.jsp">Home 5</a></li>
                                            <li><a href="index-6.jsp">Home 6</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="about.jsp">about</a></li>
                                    <li><a href="service.jsp">services</a></li>
                                    <li class="current-menu-item"><a href="pricing.jsp">pricing</a></li>
